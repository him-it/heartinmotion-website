                                ...
                                <tbody>
                                    {eventData.events_eventshift?.filter(shift => shift.start_time > new Date()).reverse().map((shift, key) => (
                                        <tr key={key} className="border-b hover:bg-gray-50">
                                            ...
                                            <td className="border border-gray-300 p-2">{shift.start_time.toLocaleDateString('en', { weekday: 'long', day: 'numeric', month: 'long', year: 'numeric' })}</td>
                ...
                {showPopup && selectedShift && (
                    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
                        <div className="bg-white p-6 rounded-lg shadow-lg w-[90%] md:w-[60%]">
                            ...
                            <p className="mb-4">
                                <strong>Date:</strong> {selectedShift.events_eventsignup_shifts[0]?.events_eventshift.start_time.toLocaleDateString()}
                            </p>
                            <p className="mb-4">
